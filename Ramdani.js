...
//━━━━━━━━━━━━━━━[ HARI HARI ]━━━━━━━━━━━━━━━\\
        ...
        const isUrl = (url) => {
			...
			const reply = (teks) => {
			Ramdani.sendMessage(from, teks, text, { thumbnail: gember, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} WIB - ${week}`,body:"New Base By Ramdani Official",previewType:"PHOTO",thumbnail:gember,sourceUrl:`https://wa.me/p/6349482305092740/6285697662826`}}})
		}
		const reply2 = (teks) => {
...
const froxx = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text": `New Base By Ramdani Official`,
                 "title": `New Base By Ramdani Official`,
...
//━━━━━━━━━━━━━━━[ BUAT BIO BOT ]━━━━━━━━━━━━━━━\\
runi = process.uptime() 
           Ramdani.setStatus(`Ramdani botz Aktif Selama ${kyun(runi)} `).catch((_)=>_);
